...
-- 1. Seed Sources
INSERT INTO watchlist_sources (id, code, name, type, credibility_weight, active, created_at, updated_at, version) VALUES
...
-- 2. Seed Categories
INSERT INTO watchlist_categories (id, code, name, description, base_risk_score, is_active, created_at, updated_at, version) VALUES
...
(1008, 5, 4, 'Neel Chhatbar', 'NEELCHHATBAR', 'MEDIUM', 'PAN12345NC', '888800001008', 'Indian', 'Accounting Firm', 'CA', '{"status":"Debarred"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),

-- === SCENARIO 4: MULTIPLE SOURCES, ONE CATEGORY ===
-- Tanmay Jotangia (CRIMINAL) listed by CBI, INTERPOL, and INTERNAL
(1009, 1, 3, 'Tanmay Jotangia', 'TANMAYJOTANGIA', 'HIGH', 'TANM12345J', '888800001009', 'Indian', 'Syndicate', 'Leader', '{"record":"Criminal"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1010, 1, 2, 'Tanmay Jotangia', 'TANMAYJOTANGIA', 'HIGH', 'TANM12345J', '888800001009', 'Indian', 'Syndicate', 'Leader', '{"record":"Interpol Red Notice"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1011, 1, 7, 'Tanmay Jotangia', 'TANMAYJOTANGIA', 'HIGH', 'TANM12345J', '888800001009', 'Indian', 'Syndicate', 'Leader', '{"record":"Internal HR flagged"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),

-- === SCENARIO 5: ONE SOURCE, MULTIPLE CATEGORIES ===
-- Vrunda Chavda flagged by INTERNAL HR for Fraud, Employment Issue, Blacklist
(1012, 2, 7, 'Vrunda Chavda', 'VRUNDACHAVDA', 'HIGH', 'VRUN12345C', '888800001012', 'Indian', 'Tech Mahindra', 'Developer', '{"issue":"Financial Fraud"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1013, 6, 7, 'Vrunda Chavda', 'VRUNDACHAVDA', 'MEDIUM', 'VRUN12345C', '888800001012', 'Indian', 'Tech Mahindra', 'Developer', '{"issue":"Faked Degree"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1014, 3, 7, 'Vrunda Chavda', 'VRUNDACHAVDA', 'LOW', 'VRUN12345C', '888800001012', 'Indian', 'Tech Mahindra', 'Developer', '{"issue":"Blacklisted Employee"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),

-- === SCENARIO 6: MULTIPLE SOURCES, MULTIPLE CATEGORIES ===
-- Vivek Dadhaniya (Complex case - PEP, Fraud, Criminal from different sources)
(1015, 4, 6, 'Vivek Dadhaniya', 'VIVEKDADHANIYA', 'MEDIUM', 'VIVK12345D', '888800001015', 'Indian', 'Govt of India', 'Minister', '{"role":"PEP"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1016, 1, 3, 'Vivek Dadhaniya', 'VIVEKDADHANIYA', 'HIGH', 'VIVK12345D', '888800001015', 'Indian', 'Govt of India', 'Minister', '{"crime":"Money Laundering"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1017, 2, 4, 'Vivek Dadhaniya', 'VIVEKDADHANIYA', 'HIGH', 'VIVK12345D', '888800001015', 'Indian', 'Govt of India', 'Minister', '{"case":"Insider Trading"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1018, 6, 7, 'Vivek Dadhaniya', 'VIVEKDADHANIYA', 'MEDIUM', 'VIVK12345D', '888800001015', 'Indian', 'Govt of India', 'Minister', '{"issue":"Falsified Records"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),

-- === SCENARIO 7: NAME & ORG & DESIGNATION MATCHES ===
-- Bhavika Chhatbar matches with Org and Designation
(1019, 6, 7, 'Bhavika Chhatbar', 'BHAVIKACHHATBAR', 'MEDIUM', 'BHAV12345C', '888800001019', 'Indian', 'QuickHire Solutions', 'HR Manager', '{"type":"Employment Fraud"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1020, 2, 3, 'Bhavika Chhatbar', 'BHAVIKACHHATBAR', 'HIGH', 'BHAV12345C', '888800001019', 'Indian', 'QuickHire Solutions', 'HR Manager', '{"case":"Recruitment Scam"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),

-- === SCENARIO 8: ONLY ID MATCHES (NAME DIFFERENT/ALIAS) ===
-- Darshit Dhaduk (Using an alias D. Dhaduk, but exact PAN match)
(1021, 4, 6, 'D. Dhaduk', 'DDHADUK', 'LOW', 'DARS12345D', '888800001021', 'Indian', 'Local Party', 'Member', '{"role":"PEP"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1022, 5, 10, 'Darshit Dhaduk', 'DARSHITDHADUK', 'MEDIUM', 'DARS12345D', '888800001021', 'Indian', 'Defunct Corp', 'Director', '{"status":"Disqualified"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
...
(1026, 3, 7, 'Shree Traders Pvt Ltd', 'SHREETRADERS', 'MEDIUM', 'SHRE12345T', '888800001026', 'Indian', 'Shree Traders Pvt Ltd', 'Vendor', '{"issue":"Fake billing"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1027, 6, 7, 'QuickHire Solutions', 'QUICKHIRESOLUTIONS', 'MEDIUM', 'QUIC12345H', '888800001027', 'Indian', 'QuickHire Solutions', 'Agency', '{"issue":"Job Scam"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1028, 4, 6, 'Lalu Prasad Yadav', 'LALUPRASADYADAV', 'MEDIUM', 'LALU12345P', '888800001028', 'Indian', 'RJD', 'Politician', '{"position":"Politician"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1029, 2, 4, 'Ketan Parekh', 'KETANPAREKH', 'HIGH', 'KETA12345P', '888800001029', 'Indian', 'KP Group', 'Broker', '{"case":"Stock Market Scam"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
(1030, 5, 4, 'Suresh Accountant', 'SURESHACCOUNTANT', 'MEDIUM', 'SURE12345A', '888800001030', 'Indian', 'Suresh Associates', 'CA', '{"status":"License Revoked"}'::jsonb, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0);

-- 4. Seed Aliases
INSERT INTO watchlist_aliases (id, entry_id, source_id, alias_name, alias_name_normalized, alias_type, created_at, updated_at, version) VALUES
...
INSERT INTO watchlist_evidence_documents (id, entry_id, source_id, cloud_storage_key, file_name, file_format, evidence_type, created_at, updated_at, version) VALUES
...
INSERT INTO system_config (config_key, config_value, config_type, category, description, is_sensitive, created_at, updated_at, version) VALUES
